=== ASD wpkses tags script ===
Contributors: michaelfahey
Tags: wp_kses, allowedtags, script
Requires PHP: 5.6
...
Plugin URI:  https://artisansitedesigns.com/plugins/asd-wpkses-tags-script/
Author URI:  https://artisansitedesigns.com/staff/michael-h-fahey/
Donate link: https://paypal.me/artisanmichaelfahey

=== Description ===
This plugin configures WordPress sanitizing functions such as wp_kses to allow the script tag, and the type attribute for the script tag. It does not affect any other allowed/disallowed tags or attributes.
...
git clone https://github.com/MichaelFahey/asd-wpkses-tags-script.git
